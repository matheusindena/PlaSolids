...
def animationIcosahedron():
    
    # Encontrando e atribuindo o controlador lógico a variável 'cont'
    cont = bge.logic.getCurrentController()
    
    # Verifica se o icosaedro esta visivel
    if bge.logic.getCurrentScene().objects['Icosahedron'].visible:
        ...
        if cont.sensors["Scroll Up"].positive and bge.logic.getAnimRecordFrame() > 0:
            ...
            act = cont.actuators["Icosahedron Action"]
        
            # Designa qual ação será executada
            act.action = "Icosahedron Animation"
